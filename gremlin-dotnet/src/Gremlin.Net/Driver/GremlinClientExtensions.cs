...
namespace Gremlin.Net.Driver
{
    ...
    public static class GremlinClientExtensions
    {
        ...
        {
            var resultCollection = await gremlinClient.SubmitAsync<T>(requestScript, bindings, cancellationToken).ConfigureAwait(false);
        ...
        public static async Task<T> SubmitWithSingleResultAsync<T>(this IGremlinClient gremlinClient,
            ...
            CancellationToken cancellationToken = default)
        {
            var resultCollection = await gremlinClient.SubmitAsync<T>(requestMessage, cancellationToken).ConfigureAwait(false);
            return resultCollection.FirstOrDefault();
        }
        ...
        ///     that an error occurred.
        /// </exception>
        public static async Task SubmitAsync(this IGremlinClient gremlinClient, RequestMessage requestMessage, CancellationToken cancellationToken = default)
        {
